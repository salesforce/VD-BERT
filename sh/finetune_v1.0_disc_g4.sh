...
checkpoint_output=v${visdial_v}_${loss_type}_disc_g4
...
python vdbert/train_visdial.py \
    ...
    --s2s_prob 0 --bi_prob 1 --loss_type ${loss_type} --max_pred 0 --neg_num 1 --multiple_neg 1 \
    --inc_full_hist 1  --max_len_hist_ques 200 --max_len_ans 10 \
    --num_workers 4 --train_batch_size ${bs}  --use_num_imgs ${use_num_imgs} --num_train_epochs 15 \
