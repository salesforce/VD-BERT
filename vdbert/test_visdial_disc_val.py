...
from vdbert.seq2seq_loader import Preprocess4TestVisdialDisc
...
def process_args():
    ...
    parser.add_argument('--max_len_hist_ques', type=int, default=20)
...
def main():
    ...
    bi_uni_pipeline = [Preprocess4TestVisdialDisc(list(tokenizer.vocab.keys()),
                                                  ...
                                                  inc_full_hist=args.inc_full_hist, only_qa=args.only_qa)]
    ...
    for model_recover_path in glob.glob(args.model_recover_path.strip()):
        ...
        model = BertForPreTrainingLossMask.from_pretrained(
            ...
            add_attn_fuse=args.add_attn_fuse, no_vision=args.no_vision)
        ...
        with tqdm(total=total_batch) as pbar:
            while next_i < len(input_lines):
                ...
                with torch.no_grad():
                    ...
                    input_mask_turns = [[x[turn_i] for x in batch_data[2]] for turn_i in range(10)]
