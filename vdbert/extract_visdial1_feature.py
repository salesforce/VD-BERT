...
def load_image_ids(img_root, split_dir):
    ...
    pathXid = []
    img_root = os.path.join(img_root, 'VisualDialog_{}2018'.format(split_dir))
...
def generate_tsv(prototxt, weights, image_ids, outfile):
    ...
    if len(missing) > 0:
        ...
        print "\n\nBegin testing, elapse time: %.2f" % (time.time() - t0)
        cnt = 0
            ...
            for im_file, image_id in tqdm(image_ids):
                if image_id in missing:
                    try:
                        ...
                        print(e)
                # if cnt == 10:
                #     print "Break at 10 for debugging"
                #     break
...
def parse_args():
    ...
    parser.add_argument('--out', dest='outfile',
                        ...
                        default='/export/home/DAN-VisDial/data/img_feats', type=str)
    parser.add_argument('--cfg', dest='cfg_file',
                        help='optional config file', default=None, type=str)
    parser.add_argument('--set', dest='set_cfgs',
                        help='set config keys', default=None,
                        nargs=argparse.REMAINDER)
    parser.add_argument('--imgroot', type=str, default='/export/home/DAN-VisDial/data/images')
    parser.add_argument('--split', type=str, default='test', help='test | val')
    parser.add_argument('--caffemodel', type=str, default='./data/faster_rcnn_models/resnet101_faster_rcnn_final_iter_320000.caffemodel')
...
if __name__ == '__main__':
    ...
    args.outfile = "%s/%s_obj36.tsv" % (args.outfile, args.split)
    ...
    print "Loading %d images, the first image: %s" % (len(image_ids), image_ids[0])
